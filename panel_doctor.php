...
<a href="panel_doctor.php">🏠 Inicio</a>
...
$diagnosticos = mysqli_num_rows(mysqli_query($conexion,"SELECT * FROM diagnosticos"));
?>
...
<div class="col-md-4">
<a href="diagnostico.php" style="text-decoration:none; color:white;">
<div class="card-box text-center">
<h4>🩺 Diagnósticos</h4>
<h2><?php echo $diagnosticos; ?></h2>
</div>
</a>
</div>
...
<p>Accede a pacientes, registra diagnósticos y consulta historiales clínicos.</p>
</div>
